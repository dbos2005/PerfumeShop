                ...
                <table style="max-width: 600px;">
                    ...
                    <tr>
                        <td>
                            ...
                            <div>
                                <a href="http://localhost/Perfume/resetPassword.php?vcode='.$vcode.'" style="text-decoration: none;display: inline-block;border-radius:8px;color: white; padding: 15px; background-color: blue;">
